...
export function AddPathfinderPoint() {

    const [selectIndividual, setSelectIndividual] = useState<any>();
    ...
    function handleFields(form: UsuarioPontoProps) {

        if (selectIndividual == null || datePontos == '') {
            Alert.alert('por favor selecione o desbravador e a data');
        }

        form.usuario_id = selectIndividual;
    ...
    return (
        <Container>
            <HeaderApp
                title='Adicionar Ponto de Desbravador'
            />
            <WrapperContent>
                <Form>
                    <Fields>
                        ...
                        <TextInput>Desbravador:</TextInput>
                        <Picker
                            style={
                                {
                            ...
                            selectedValue={selectIndividual}
                            onValueChange={(itemValue, itemIndex) => setSelectIndividual(itemValue)}

                        >
                            <Picker.Item label="Selecione" value={null} />
                            <Picker.Item label="Fulano" value="1" />
                            <Picker.Item label="Ciclano" value="2" />
                            <Picker.Item label="Deotrano" value="3" />
                        </Picker>
